            ...
            <div class="row" >
                <div class="card ">
                    ...
                    <div class="form-group">
                        <label for="exampleInputUser">Email address</label>
                        <input type="email" class="form-control" id="exampleInputUser" aria-describedby="userHelp" placeholder="Enter Username">
